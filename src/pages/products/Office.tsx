        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-start gap-0">
                {/* Purple Rubber Stamp */}
                ...
                <div className="text-center sm:text-left">
                  <span className="block text-sm font-bold text-purple-600 tracking-widest uppercase mb-0">unified</span>
            ...
            >
              <div className="relative w-full max-w-2xl">
                ...
                <div
                  className="relative rounded-3xl shadow-2xl shadow-purple-900/10 border-4 border-white aspect-[4/3] w-full px-3 bg-white"
