...
const features = [
  {
    icon: <HotelIcon className="w-12 h-12 text-amber-400 mb-4" />,
    title: "Smart Booking",
    desc: "Intelligent reservation system with dynamic pricing and channel management across all platforms."
  },
  {
    icon: <Star className="w-12 h-12 text-orange-400 mb-4" />,
    title: "Guest Personalization",
    desc: "AI learns guest preferences to provide personalized experiences and recommendations."
  },
  {
    icon: <DollarSign className="w-12 h-12 text-amber-400 mb-4" />,
    title: "Revenue Optimization",
    desc: "Dynamic pricing algorithms maximize revenue based on demand, seasonality, and market trends."
  }
];

// Particle system component for Hotel
const HotelParticlesBackground = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <div className="fixed inset-0 -z-5 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-40 left-20 w-6 h-6 bg-orange-400/30 rounded-full"
          animate={{
            y: [0, 40, 0],
            x: [0, 10, 0],
          }}
            ...
            <div className="space-y-8">
              ...
              >
                <motion.div
                  ...
                  whileTap="tap"
                >
                  <Button size="lg" className="bg-amber-500 hover:bg-amber-600 text-white font-bold text-lg px-10 py-7 rounded-2xl shadow-2xl">
                ...
                >
                  <Button size="lg" variant="outline" className="border-2 font-bold text-lg px-10 py-7 rounded-2xl backdrop-blur-md relative overflow-hidden">
                    ...
                    />
                    <HotelIcon className="w-5 h-5 mr-3" />
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-orange-600">95% Satisfaction</span>
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
      ...
      <main className="pt-20 pb-16 relative z-10">
              ...
              {features.map((feature, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-amber-50/50 to-orange-50/30"
                ...
                <ul className="space-y-5 relative z-10">
                  {[
                    ...
                    <motion.li
                      ...
                      whileHover={{ x: 5 }}
                    >
                      <Check className="w-6 h-6 text-amber-500 mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </motion.li>
                  ))}
                </ul>
        ...
        <section className="py-24 container mx-auto px-4">
          ...
          >
            {/* Animated background elements */}
            <motion.div
              className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-400 via-orange-400 to-yellow-400"
              animate={{
                scaleX: [0, 1, 0],
