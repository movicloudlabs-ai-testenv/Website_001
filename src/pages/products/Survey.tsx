  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <div className="fixed inset-0 -z-5 overflow-hidden">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-indigo-300/20 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-1/3 -right-20 w-80 h-80 bg-blue-300/20 rounded-full blur-3xl animate-pulse-slower"></div>
            ...
            <AnimatePresence>
              {features.map((feature, idx) => {
                ...
                return (
                  <motion.div
                    key={idx}
                    className="absolute w-96 h-[420px] bg-white/95 backdrop-blur-lg rounded-3xl p-10 border border-indigo-100/60 shadow-2xl cursor-pointer flex flex-col items-center justify-center relative overflow-hidden"
                  ...
                  >
                    ...
                    <motion.div
                      className={`absolute bottom-6 w-3 h-3 rounded-full ${
                        isActive ? 'bg-gradient-to-r from-indigo-400 to-blue-400' : 'bg-slate-300'
                      }`}
                      animate={{
