...
const CareerPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-sky-100 selection:text-sky-900 scroll-smooth">
      ...
      <section className="relative pt-20 pb-6 lg:pt-32 lg:pb-10 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-8 tracking-tight font-display">
                Join the <span className="text-sky-600">MoviCloud Labs</span> team
              </h1>

              <p className="text-lg md:text-xl text-slate-600 leading-loose tracking-wide font-light font-heading max-w-2xl mb-12">
                Redefining digital product innovation by synthesizing advanced analytics and AI into seamless, high-impact experiences. We empower users with scalable, enterprise-grade solutions that drive sustainable value and transformative growth.
              </p>
      ...
      <section id="culture" className="pt-8 pb-16 lg:pt-12 lg:pb-20 bg-slate-50">
